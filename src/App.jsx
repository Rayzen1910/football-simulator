...
function App() {
  ...
  const createTemplateTournament = (template) => {
    ...
    if (template === 'ucl') {
      ...
      name = 'FIFA World Cup';
      type = 'knockout';
      teams = ['Argentina', 'France', 'Brazil', 'England', 'Spain', 'Portugal', 'Germany', 'Netherlands', 'Italy', 'Croatia', 'Uruguay', 'Colombia', 'Belgium', 'Morocco', 'Japan', 'USA', 'Senegal', 'South Korea', 'Switzerland', 'Denmark', 'Mexico', 'Ecuador', 'Poland', 'Australia', 'Cameroon', 'Canada', 'Serbia', 'Ghana', 'Saudi Arabia', 'Iran', 'Wales', 'Costa Rica'];
